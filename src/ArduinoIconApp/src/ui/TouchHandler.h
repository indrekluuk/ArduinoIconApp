...
#ifndef ARDUINOICONAPP_TOUCHHANDLER_H
#define ARDUINOICONAPP_TOUCHHANDLER_H



#include <Arduino.h>
#include "../lib/Touch-Screen-Library_mod/TouchScreen.h"
...
#endif //ARDUINOICONAPP_TOUCHHANDLER_H
