...
const PROGMEM IconBufferProgMem::IconData ICON_LOAD = {
    IconColor(Palette::BLACK, Palette::WHITE, Palette::BLACK, false, false),
    {
        ...
        (uint16_t) 0b0000111100100011,
        (uint16_t) 0b0011100000101111,
        (uint16_t) 0b1110000000111111,
        (uint16_t) 0b1000000011111111,
        (uint16_t) 0b1000011111111111,
        (uint16_t) 0b1100011111111110,
        (uint16_t) 0b0100011111111110,
        (uint16_t) 0b0100011111111110,
        (uint16_t) 0b0110111111111110,
        (uint16_t) 0b0010111111111100,
        (uint16_t) 0b0010111111110000,
