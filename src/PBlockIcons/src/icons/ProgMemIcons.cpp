...
const PROGMEM IconBufferProgMem::IconData ICON_LOAD = {
    IconColor(Palette::BLACK, Palette::WHITE, Palette::BLACK, false, false),
    {
        ...
        (uint16_t) 0b0000000000000000,
        (uint16_t) 0b0000000000000000,
        (uint16_t) 0b0000000001111111,
        (uint16_t) 0b0000000001000001,
        (uint16_t) 0b0000000111111101,
        (uint16_t) 0b0010000100000101,
        (uint16_t) 0b0110011111110101,
        (uint16_t) 0b1110010000010101,
        (uint16_t) 0b0110010110010111,
        (uint16_t) 0b0010010010010100,
        (uint16_t) 0b0000010011011100,
        (uint16_t) 0b0000010000010000,
